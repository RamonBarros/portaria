class VisitantesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @visitante.save
        format.html { redirect_to visitantes_url, notice: 'Visitante was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @visitante.update(visitante_params)
        format.html { redirect_to visitantes_url, notice: 'Visitante was successfully updated.' }
  ...
  private
    ...
    def visitante_params
      params.require(:visitante).permit(:nome, :cpf, :rg, :telefone)
    end
end
