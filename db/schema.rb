...
ActiveRecord::Schema.define(version: 20160605215945) do

  create_table "porteiros", force: :cascade do |t|
  ...
  create_table "visita", force: :cascade do |t|
    t.integer  "visitante_id", limit: 4
    t.datetime "dataEntrada"
    t.datetime "dataSaida"
    t.integer  "conjunto",     limit: 4
    t.string   "responsavel",  limit: 255
    t.datetime "created_at",               null: false
    t.datetime "updated_at",               null: false
  end

  add_index "visita", ["visitante_id"], name: "index_visita_on_visitante_id", using: :btree
