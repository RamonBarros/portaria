...
class VisitantesControllerTest < ActionController::TestCase
  ...
  test "should create visitante" do
    assert_difference('Visitante.count') do
      post :create, visitante: { cpf: @visitante.cpf, nome: @visitante.nome, rg: @visitante.rg, telefone: @visitante.telefone }
    end
  ...
  test "should update visitante" do
    patch :update, id: @visitante, visitante: { cpf: @visitante.cpf, nome: @visitante.nome, rg: @visitante.rg, telefone: @visitante.telefone }
    assert_redirected_to visitante_path(assigns(:visitante))
  end
