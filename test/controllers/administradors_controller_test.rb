...
class AdministradorsControllerTest < ActionController::TestCase
  ...
  test "should create administrador" do
    assert_difference('Administrador.count') do
      post :create, administrador: { cpf: @administrador.cpf, nome: @administrador.nome, rg: @administrador.rg, telefone: @administrador.telefone }
    end
  ...
  test "should update administrador" do
    patch :update, id: @administrador, administrador: { cpf: @administrador.cpf, nome: @administrador.nome, rg: @administrador.rg, telefone: @administrador.telefone }
    assert_redirected_to administrador_path(assigns(:administrador))
  end
